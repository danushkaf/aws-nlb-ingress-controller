...
import (
	...
	controllercfn "github.com/danushkaf/aws-nlb-ingress-controller/pkg/cloudformation"
					...
					Stacks: map[string]*cloudformation.Stack{
						"complete": &cloudformation.Stack{
							...
							Outputs: []*cloudformation.Output{
								&cloudformation.Output{OutputKey: aws.String(controllercfn.OutputKeyNLBEndpoint), OutputValue: aws.String("foo.com")},
							},
						},
					},
				},
